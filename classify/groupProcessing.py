...
# ------------------------parameters setting
#holoPath = r'../samples/Copepod/'
#holoPath = r'../samples/chaetoceros-concavicornis/'
holoPath = r'../samples/cf-strombidium-sp/'
#holoPath = r'../samples/diatom/'
#holoPath = r'../samples/ditylum-brightwelli/'
#holoPath = r'../samples/thalassiosira-sp/'
#holoPath = r'../samples/tripos-cf-furca/'
#holoPath = r'../samples/tripos-cf-muelleri/'
#holoPath = r'../samples/copepod-nauplius/'
#holoPath = r'../samples/chaetoceros-debilis/'


netPath = r'../shufflenet_v2_x1_5_10classes_batch326.pt'
classNum = 10
fileType = '.tif'
